...
Answer:
    ...
    SELECT COUNT(*) 
    FROM `your_project_id.your_prod_dataset.fact_trips`
...
Answer:
    ...
    SELECT COUNT(*) 
    FROM `your_project_id.your_dev_dataset.stg_fvh_trip_data`
...
Answer:
    ...
    SELECT COUNT(*) 
    FROM `your_project_id.your_dev_dataset.fact_fvh_trips`
    WHERE EXTRACT(YEAR FROM pickup_datetime) IN (2019)
